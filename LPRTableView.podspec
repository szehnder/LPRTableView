#
#  Be sure to run `pod spec lint LPRTableView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Nicolas Gomollon" => "notsure@gmail.com" }
  # Or just: s.author    = "Sean Zehnder"
  # s.authors            = { "Sean Zehnder" => "seanzehnder@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Sean Zehnder"
  ...
  s.source       = { :git => "https://github.com/szehnder/LPRTableView.git", :tag => "0.0.1" }
